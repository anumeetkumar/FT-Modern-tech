  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn("rounded-none bg-accent/60 text-accent-foreground", defaultClassNames.range_middle),
        ...
        Chevron: ({ className, orientation, ...props }) => {
          const Icon =
            orientation === "left"
              ...
              ? ChevronRightIcon
              : ChevronDownIcon
          return <Icon fontSize="small" className={cn("text-muted-foreground", className)} {...props} />
        },
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        data-[range-middle=true]:bg-primary/30 data-[range-middle=true]:text-accent-foreground
